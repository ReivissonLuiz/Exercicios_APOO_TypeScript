export function calculadoraIMC(rl: any, callback: Function): void {
    
    // Pergunta o peso
    rl.question("Digite seu peso (em kg): ", (pesoInput: string) => {
        const peso = parseFloat(pesoInput); // Converte pra número

        // Pergunta a altura
        rl.question("Digite sua altura (em metros): ", (alturaInput: string) => {
